...
start_time= create_datetime(min=55,hours=23,days=3,months=1,years=2018)
COM = 'COM7'
#region classes
try:
    port = Port(COM)
    create_frame_Podzielnik_1 = Create_frames(int_SN=2000040816,start_time=start_time,Port_COM_class=port)
...
port.filtered_SN = [2000040816] #wewnatrz filtrowane SNy przykladowo [2000004927,2000004921,itd]
# Klucz = 2020
# adres = DD
# OMT   = 30
# nadawanie 27/7
